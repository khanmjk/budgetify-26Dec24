...
import { BusinessTravelDetail } from '../../types/models';
import { Plane, Hotel, Car, Calendar, Users, DollarSign } from 'lucide-react';

interface BusinessTravelListProps {
  travels: BusinessTravelDetail[];
}

export const BusinessTravelList: React.FC<BusinessTravelListProps> = ({ travels }) => {
  if (travels.length === 0) {
    return (
