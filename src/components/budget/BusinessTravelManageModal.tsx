...
import { BusinessTravelList } from './BusinessTravelList';
import { TravelType, TravelCategory } from '../../types/enums';
import { generateId } from '../../utils/generateId';
import { AlertTriangle, Plus } from 'lucide-react';

interface BusinessTravelManageModalProps {
  budgetItemId: string;
  onClose: () => void;
}

export const BusinessTravelManageModal: React.FC<BusinessTravelManageModalProps> = ({
  budgetItemId,
  onClose
}) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const currentSpent = budgetItem.businessTravelDetails?.reduce((sum, detail) => sum + detail.totalAmount, 0) || 0;
    ...
    const travelDetail = {
      ...
      travelCategory: formData.travelCategory,
    ...
    const updatedBudgetItem = {
      ...
      businessTravelDetails: [...(budgetItem.businessTravelDetails || []), travelDetail]
    };
    ...
    <div className="fixed inset-0 bg-gray-500 bg-opacity-75 flex items-center justify-center p-4 z-50">
      <div className="bg-white rounded-lg max-w-4xl w-full p-6 max-h-[90vh] overflow-y-auto">
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-lg font-medium text-gray-900">Business Travel Management</h2>
        ...
        {showForm ? (
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <select
                    ...
                    className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                  >
                    {Object.values(TravelCategory).map(category => (
          ...
          <div className="mt-6">
            ...
            <BusinessTravelList travels={budgetItem.businessTravelDetails || []} />
          </div>
        )}
      </div>
    </div>
